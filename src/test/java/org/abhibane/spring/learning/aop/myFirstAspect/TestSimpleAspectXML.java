...
public class TestSimpleAspectXML {
	...
	@Test
	public void aspectisAroundCalled() {
		tracingAspect.isAround =false;
		assertFalse(tracingAspect.isAroundCalled());
		simpleService.doSomething();;
		assertTrue(tracingAspect.isAroundCalled());
	}
}
